...
- **tab:resumen (nueva, §4.10)** ✅ **agrega resultados existentes** (sin números nuevos): Dice 0.967 · LOPO 0.955±0.013 · AUROC E2E esperado 0.977±0.004 / desplegado 0.968 / mejor 0.982 · latencias ONNX de `results/latency.json` (sellado @1280 342 ms, defecto 65/40 ms, E2E ~630 ms→~100/min, INT8@384 ~19 ms/4.2 MB). Reconcilia esperado/desplegado/mejor E2E en un solo sitio; `tab:aug` reetiquetada `(config. desplegada)` con nota apuntando a `tab:umbral`.

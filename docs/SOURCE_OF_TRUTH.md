...
- **tab:sistemas (4.9)** ✅ comparación E2E homogénea (`core.py`, modelos de sellado por resolución, conjunto común 176: 23 def/153 correcto): desplegado 1280+ResNet18 = **0.968 · 21/23** (reproduce tab:umbral); las 6 configs 0.968-0.982, equivalentes (±0.01). `evaluation/eval_systems_e2e.py`, `results/systems_e2e.json`.

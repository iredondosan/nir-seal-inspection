#!/usr/bin/env python3
"""Seal fine-tune: continue from best_lite.pt over all 6 reviewed products (prod1..prod6,
pack-cropped, MobileNetV3-small U-Net). Resolution set via --img (default 512); the DEPLOYED
model was trained at 1280 (--img 1280 --batch 2 --epochs 40). Saves the best-by-validation-Dice
checkpoint to models/best_lite_reviewed_{IMG}.pt (+ ONNX). --scratch = random init for the
from-scratch ablation. Reports per-product validation Dice."""

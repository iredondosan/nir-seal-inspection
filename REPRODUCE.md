...
| **Tabla 4.7** · Ablación de aumentación | `python experiments/ablation_augment.py` | `defect_{strip.noaug,roll,jit,rolljit}.pt` sobre hold-out (23 def) | base 0.975/0.953 · +roll 0.980/0.983 · **+sealjit 0.984/0.975 (23/23, 3.8 % FP)** · +ambos 0.976/0.976 |
...
- El modelo `sealjit` de la ablación (Tabla 4.7, 0.975 e2e) y el `defect_strip.pt` desplegado (0.968

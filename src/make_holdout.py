...
SOURCES = [("data/annotations/prod1_reviewed.xml", "prod1", "all"),
           ...
           ("data/annotations/prod5_reviewed.xml", "prod5", "all"),
           ("data/annotations/prod6_reviewed.xml", "prod6", "good"),
           ("data/annotations/prod6_bad_reviewed.xml", "prod6_bad", "defect_reviewed")]
